    ...
    <div className="min-h-screen pt-[64px] space-y-6">
      ...
      <div className="flex flex-col justify-center items-center">
        <div className="wrapper">
          <div className="relative w-[80vw] h-[300px] flex flex-col justify-end space-y-4  items-center">
      ...
      <div className="flex flex-col justify-center items-center">
        <div className="wrapper">
          <div className="relative w-[80vw] h-[300px]  rounded-lg flex flex-col justify-end space-y-4  items-center">
            <div className="absolute outline px-4 rounded-md top-5 left-5">
              PRO
            </div>
